...
public class DetailsDayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (listMeteoData != null) {
            ...
            if (listMeteoData.size() >= 8) {
                Log.d(TAG, "taille liste " + listMeteoData.size());
